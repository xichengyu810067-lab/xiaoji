...
const commandGroups = [
  {
    ...
    commands: [
      ...
      ['/weather city', '查詢城市或臺灣縣市行政區天氣，例如 新竹竹北'],
      ['/poll question option1 option2', '建立按鈕投票'],
      ['/remind time message', '設定提醒'],
      ['/calendar add/list/delete', '管理行事曆'],
      ['/music play/queue/status/skip/pause/resume/stop/leave', '播放 YouTube 音樂與查看 Lavalink 節點狀態'],
      ['/ticket open/status', '在客服入口建立私人客服單或查看狀態'],
      ['/coins user', '查詢吉幣餘額'],
      ['/daily', '每日簽到領取吉幣'],
