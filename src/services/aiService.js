...
const developerInstructions = [
  ...
  'Xiaoji supports these slash commands: /help, /ping, /status, /about, /fortune, /roll, /weather, /poll, /remind, /calendar, /music, /coins, /daily, /leaderboard, /shop, /buy, /inventory, /bank, /casino, /work, /announce, /autorole, /automod, /config, /export-config, /set-log, /clear, /timeout, /mute, /kick, /ban, /unban, /role-add, /role-remove.',
